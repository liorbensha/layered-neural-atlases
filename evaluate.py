...
def evaluate_model(model_F_atlas,
        ...
        for f in range(number_of_frames):
            ...
            for i in range(len(relisa)):
                ...
                flow_alpha_loss = get_optical_flow_alpha_loss_all(
                    model_alpha, jif_foreground, alpha, larger_dim,
    ...
    writer_t_edited1 = imageio.get_writer("%s/edited1_%s.mp4" %
    ...
    writer_im_rec = imageio.get_writer("%s/reconstruction_%s.mp4" %
                                       (evaluation_folder, vid_name),
                                       fps=10)
